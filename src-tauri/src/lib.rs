...
use commands::{
    ...
    import_epub, import_markdown, import_markdown_content, import_url, index_document,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            import_epub,
            publication_import_existing_v2,
            publication_open_v2,
            publication_get_blocks_v2,
            publication_get_position_v2,
            publication_save_position_v2,
